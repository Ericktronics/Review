...
export function Sidebar({ categories, selected, counts, total, onSelect }: Props) {
  return (
    <nav className="w-56 flex-shrink-0 h-screen sticky top-0 bg-slate-900 border-r border-slate-800 flex flex-col overflow-y-auto">
