...
GRANT SELECT ON ALL TABLES IN SCHEMA public TO analytics_user;`,
...

  {
    ...
    answer:
      "**Technical debt** is the implied cost of rework caused by choosing a quick, expedient solution now instead of a better, more thorough approach. Like financial debt, it accumulates interest over time — the longer you leave it, the harder it becomes to change.\n\n**Types**:\n- **Deliberate** — consciously chosen shortcuts to meet a deadline (acceptable if paid down)\n- **Accidental** — poor decisions made without realising the consequences (common in growing codebases)\n- **Bit rot** — code that was fine but became debt as the system around it evolved\n\n**Why it slows teams down**: every new feature requires navigating and working around existing debt. Bug fixing becomes harder. New developers take longer to ramp up.\n\n**How to manage it**:\n1. **Make it visible** — track debt in your issue tracker alongside features. If it's invisible, it won't be prioritised.\n2. **Boy Scout Rule** — leave the code a little better than you found it (small refactors alongside feature work)\n3. **Dedicated debt sprints** — allocate a percentage of each sprint (e.g. 20%) to addressing debt\n4. **Prevent new debt** — code reviews, ADRs (Architecture Decision Records), test coverage requirements\n5. **Prioritise by cost** — focus on debt in high-churn areas (code you change every week) over stable code nobody touches",
  },
